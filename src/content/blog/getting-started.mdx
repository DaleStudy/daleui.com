...
description: MDX 파이프라인이 정상 동작하는지 확인하기 위한 샘플 문서입니다.
date: 2026-05-08
author: hyoseong1994
---
...
<img
  ...
  height="805"
  alt="image"
  src="https://github.com/user-attachments/assets/a6cc5d10-54f9-4536-b3d4-6f185c374e77"
/>
...
- 레이아웃 컴포넌트를 도입한 뒤, 반복되던 스타일 코드를 없애고 Flex, HStack, VStack으로 레이아웃 구조를 일관되게 중앙에서 관리할 수 있게 되었습니다.
  <img
    ...
    height="202"
    alt="image"
    src="https://github.com/user-attachments/assets/06842f2a-068d-4387-81a9-909e796ff28e"
  />
